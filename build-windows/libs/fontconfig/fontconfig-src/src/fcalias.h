...
extern __typeof (FcDirCacheCreateUUID) IA__FcDirCacheCreateUUID __attribute((visibility("hidden")));
#define FcDirCacheCreateUUID IA__FcDirCacheCreateUUID
extern __typeof (FcDirCacheDeleteUUID) IA__FcDirCacheDeleteUUID __attribute((visibility("hidden")));
...
extern __typeof (FcConfigGetFilename) IA__FcConfigGetFilename __attribute((visibility("hidden")));
...
extern __typeof (FcConfigFileInfoIterInit) IA__FcConfigFileInfoIterInit __attribute((visibility("hidden")));
#define FcConfigFileInfoIterInit IA__FcConfigFileInfoIterInit
extern __typeof (FcConfigFileInfoIterNext) IA__FcConfigFileInfoIterNext __attribute((visibility("hidden")));
#define FcConfigFileInfoIterNext IA__FcConfigFileInfoIterNext
extern __typeof (FcConfigFileInfoIterGet) IA__FcConfigFileInfoIterGet __attribute((visibility("hidden")));
...
extern __typeof (FcFreeTypeQueryAll) IA__FcFreeTypeQueryAll __attribute((visibility("hidden")));
...
extern __typeof (FcNameGetConstantFor) IA__FcNameGetConstantFor __attribute((visibility("hidden")));
...
extern __typeof (FcPatternObjectCount) IA__FcPatternObjectCount __attribute((visibility("hidden")));
...
extern __typeof (FcPatternIterStart) IA__FcPatternIterStart __attribute((visibility("hidden")));
#define FcPatternIterStart IA__FcPatternIterStart
extern __typeof (FcPatternIterNext) IA__FcPatternIterNext __attribute((visibility("hidden")));
#define FcPatternIterNext IA__FcPatternIterNext
extern __typeof (FcPatternIterEqual) IA__FcPatternIterEqual __attribute((visibility("hidden")));
#define FcPatternIterEqual IA__FcPatternIterEqual
extern __typeof (FcPatternFindIter) IA__FcPatternFindIter __attribute((visibility("hidden")));
#define FcPatternFindIter IA__FcPatternFindIter
extern __typeof (FcPatternIterIsValid) IA__FcPatternIterIsValid __attribute((visibility("hidden")));
#define FcPatternIterIsValid IA__FcPatternIterIsValid
extern __typeof (FcPatternIterGetObject) IA__FcPatternIterGetObject __attribute((visibility("hidden")));
#define FcPatternIterGetObject IA__FcPatternIterGetObject
extern __typeof (FcPatternIterValueCount) IA__FcPatternIterValueCount __attribute((visibility("hidden")));
#define FcPatternIterValueCount IA__FcPatternIterValueCount
extern __typeof (FcPatternIterGetValue) IA__FcPatternIterGetValue __attribute((visibility("hidden")));
...
extern __typeof (FcWeightFromOpenTypeDouble) IA__FcWeightFromOpenTypeDouble __attribute((visibility("hidden")));
...
extern __typeof (FcWeightToOpenTypeDouble) IA__FcWeightToOpenTypeDouble __attribute((visibility("hidden")));
...
extern __typeof (FcStrBuildFilename) IA__FcStrBuildFilename __attribute((visibility("hidden")));
