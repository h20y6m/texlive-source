...
extern __typeof (FcDirCacheCreateUUID) FcDirCacheCreateUUID __attribute((alias("IA__FcDirCacheCreateUUID"), visibility("default")));
#endif
#ifdef __fccache__
#undef FcDirCacheDeleteUUID
extern __typeof (FcDirCacheDeleteUUID) FcDirCacheDeleteUUID __attribute((alias("IA__FcDirCacheDeleteUUID"), visibility("default")));
#endif
#ifdef __fccfg__
#undef FcConfigHome
...
extern __typeof (FcConfigGetFilename) FcConfigGetFilename __attribute((alias("IA__FcConfigGetFilename"), visibility("default")));
#endif
#ifdef __fccfg__
...
extern __typeof (FcConfigFileInfoIterInit) FcConfigFileInfoIterInit __attribute((alias("IA__FcConfigFileInfoIterInit"), visibility("default")));
#endif
#ifdef __fccfg__
#undef FcConfigFileInfoIterNext
extern __typeof (FcConfigFileInfoIterNext) FcConfigFileInfoIterNext __attribute((alias("IA__FcConfigFileInfoIterNext"), visibility("default")));
#endif
#ifdef __fccfg__
#undef FcConfigFileInfoIterGet
extern __typeof (FcConfigFileInfoIterGet) FcConfigFileInfoIterGet __attribute((alias("IA__FcConfigFileInfoIterGet"), visibility("default")));
#endif
#ifdef __fccharset__
...
extern __typeof (FcFreeTypeQueryAll) FcFreeTypeQueryAll __attribute((alias("IA__FcFreeTypeQueryAll"), visibility("default")));
#endif
#ifdef __fcfs__
...
extern __typeof (FcNameGetConstantFor) FcNameGetConstantFor __attribute((alias("IA__FcNameGetConstantFor"), visibility("default")));
#endif
#ifdef __fcname__
...
extern __typeof (FcPatternObjectCount) FcPatternObjectCount __attribute((alias("IA__FcPatternObjectCount"), visibility("default")));
#endif
#ifdef __fcpat__
...
extern __typeof (FcPatternIterStart) FcPatternIterStart __attribute((alias("IA__FcPatternIterStart"), visibility("default")));
#endif
#ifdef __fcpat__
#undef FcPatternIterNext
extern __typeof (FcPatternIterNext) FcPatternIterNext __attribute((alias("IA__FcPatternIterNext"), visibility("default")));
#endif
#ifdef __fcpat__
#undef FcPatternIterEqual
extern __typeof (FcPatternIterEqual) FcPatternIterEqual __attribute((alias("IA__FcPatternIterEqual"), visibility("default")));
#endif
#ifdef __fcpat__
#undef FcPatternFindIter
extern __typeof (FcPatternFindIter) FcPatternFindIter __attribute((alias("IA__FcPatternFindIter"), visibility("default")));
#endif
#ifdef __fcpat__
#undef FcPatternIterIsValid
extern __typeof (FcPatternIterIsValid) FcPatternIterIsValid __attribute((alias("IA__FcPatternIterIsValid"), visibility("default")));
#endif
#ifdef __fcpat__
#undef FcPatternIterGetObject
extern __typeof (FcPatternIterGetObject) FcPatternIterGetObject __attribute((alias("IA__FcPatternIterGetObject"), visibility("default")));
#endif
#ifdef __fcpat__
#undef FcPatternIterValueCount
extern __typeof (FcPatternIterValueCount) FcPatternIterValueCount __attribute((alias("IA__FcPatternIterValueCount"), visibility("default")));
#endif
#ifdef __fcpat__
#undef FcPatternIterGetValue
extern __typeof (FcPatternIterGetValue) FcPatternIterGetValue __attribute((alias("IA__FcPatternIterGetValue"), visibility("default")));
#endif
#ifdef __fcweight__
...
extern __typeof (FcWeightFromOpenTypeDouble) FcWeightFromOpenTypeDouble __attribute((alias("IA__FcWeightFromOpenTypeDouble"), visibility("default")));
#endif
#ifdef __fcweight__
...
extern __typeof (FcWeightToOpenTypeDouble) FcWeightToOpenTypeDouble __attribute((alias("IA__FcWeightToOpenTypeDouble"), visibility("default")));
#endif
#ifdef __fcstr__
#undef FcStrCopy
...
extern __typeof (FcStrBuildFilename) FcStrBuildFilename __attribute((alias("IA__FcStrBuildFilename"), visibility("default")));
#endif
#ifdef __fcstr__
#undef FcStrDirname
